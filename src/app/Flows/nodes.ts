...
const dataTrends: Node[] = [
    ...
    },
    {
        ...
        position: { x: 10, y: 150 },
        data: {
            dataPoints: [76.43467918792292, 74.75843990580947, 74.11102422374006, 
    ...
    },
    {
        ...
        position: { x: 10, y: 420 },
        data: {
            dataPoints: [12.730336832141138, 12.604694698766734, 12.35465329649834, 11.97566917248127, 12.757287309888397, 12.005853441267169, 11.210677022719247, 12.272836976352318, 11.899780224253949, 12.88100770210112, 12.01900863787708, 12.68870727210575, 11.296239256518344, 11.411645600092339, 12.406272326928338, 12.751908392233394, 12.864350492706093, 12.07894051496714, 11.402549109651668, 12.283243922389508, 11.515874346541935, 11.747219974109296, 12.612106043808122, 11.704755496032696, 11.549276786052044, 12.509074178824557, 12.168556707870774, 11.102990710718434, 11.35358350537714, 12.006868750373409],
            setPoint: 12,
            limitBottom: 11,
            limitTop: 13,
            yAxis: {
    ...
    },
    {
        ...
        position: { x: 10, y: 690 },
        data: {
            dataPoints: [3.2068142219054563, 3.089922086434573, 4.815543168783922, 4.781487233844261, 4.690740298996385, 3.8765137673739485, 3.399170543314184, 4.995146211503392, 4.575575595564803, 3.72917781360293, 3.6892966746938947, 3.0436918744557873, 3.5954640075412017, 3.193617419717274, 3.067402448799161, 4.5737952823793595, 3.079184960517072, 4.425555099879878, 3.7431046695146324, 3.150440449038093, 3.049271652536881, 4.705338432714207, 4.258769151846447, 4.444730464118257, 3.140791904147615, 3.329280019548973, 4.157909076744095, 4.261435061130886, 4.673250410174235, 4.753499171846546],           
            setPoint: 4,
            limitBottom: 2.9,
            limitTop: 5.5,
            yAxis: {
    ...
    },
    {
        ...
        data: {
            dataPoints: [46.991646664511805, 46.80082086423235, 45.93282304614595, 46.31044035251841, 45.91554156496618, 43.28122256831383, 43.49725137037665, 44.076421876971956, 43.351189280504535, 46.22068529670941, 45.29317774371404, 46.812171308603254, 44.07996995031121, 45.537321128937165, 43.65454569197852, 46.21796287308248, 44.353304718707946, 46.01050298617181, 44.03296653213907, 45.17685319833875, 46.18452644815724, 46.051512963757126, 45.74029429236754, 44.719799522732565, 46.22044041643755, 43.94027595995917, 45.26255339939316, 45.447061152169454, 43.34263758684968, 43.37649658585457],
            setPoint: 45.5,
            limitBottom: 42,
            limitTop: 47,
            yAxis: {
    ...
    },
    {
        ...
        data: {
            data: [34.71618197, 36.72847734, 37.8833916, 35.37166465, 33.43345556,
                33.14414302, 37.52849639, 39.64371973, 34.08284943, 34.68095356,
                33.97920562, 37.50932246, 39.57712183, 34.25672033, 37.5869094,
                38.09142015, 37.07470128, 39.76379943, 36.00640661],
            width: 80,
    ...
    },
    {
        ...
        data: {
            data: [4.3376510867163365, 5.841831705793335, 4.716184071082504,
...
const valves: Node[] = [
    ...
    },
    {
        ...
        data: {
            valveType: 'rect', rotation: 0, state: "Open",
            handles: [
                {
                    type: "target",
                    position: Position.Left,
    ...
    },
    {
        ...
        data: {
            valveType: 'round', rotation: 0, state: "Open",
            handles: [
                {
                    type: "target",
                    position: Position.Left,
    ...
    },
    {
        ...
        data: {
            valveType: 'rect', rotation: 0, state: "Open", handles: [
                {
                    type: "target",
                    position: Position.Left,
                    id: "valve_6_target_1",
    ...
    },
    {
        ...
        data: {
            valveType: 'round', rotation: 90, state: "Open",
            handles: [
                {
                    type: "target",
                    position: Position.Right,
    ...
    },
    {
        ...
        position: { x: 800, y: 30 },
        data: {
            valveType: 'round', rotation: 180, state: "Open",
            handles: [
                {
                    type: "target",
                    position: Position.Left,
...
const gauges = [
    ...
    },
    {
        ...
        position: { x: 275, y: 20 },
        data: {
            value: 66, alarmStatus: false, thresholds: thresholdsStyle([
...
const alarmsActive: Node[] = [
    {
        id: "alarm1",
        type: "alarm",
        position: { x: -15, y: -5 },
        data: { isActive: true, type: "MEDIUM", size: 30 },
        parentNode: "lGauge2"
    },
    {
        id: "alarm3",
        type: "alarm",
        position: { x: -15, y: -5 },
        data: { isActive: true, type: "LOW", size: 30 },
        parentNode: "lGauge3"
    },
    {
        id: "alarm2",
        type: "alarm",
        position: { x: -15, y: -5 },
        data: { isActive: true, type: "HIGH", size: 40 },
        parentNode: "motorFan",
        zIndex: 40
    }
]
...
const valvesDeactivated: Node[] = [
    ...
    },
    {
        ...
        position: { x: 200, y: 640 },
        data: {
            valveType: 'round', rotation: 0, state: "Closed",
            handles: [
                {
                    type: "target",
                    position: Position.Left,
    ...
    },
    {
        ...
        position: { x: 730, y: 700 },
        data: {
            valveType: 'round', rotation: 90, state: "Closed",
            handles: [
                {
                    type: "target",
                    position: Position.Right,
...
export const PIDNodesAlarm: Node[] = [
    ...dataTrends,
    ...navButtons,
    ...controlCards,
    ...valvesDeactivated,
