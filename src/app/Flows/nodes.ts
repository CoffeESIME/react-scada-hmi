...
const navButtons: Node[] = [
  {
    ...
    type: 'card',
    position: { x: 30, y: 900 },
    data: { label: ['Main', 'Menu'], href: '/scada' },
  },
  {
    id: 'buttonCard2',
    type: 'card',
    position: { x: 160, y: 900 },
    data: { label: ['Level 1', 'Reaction', 'Overview'], href: '/screens/reaction-overview' },
  },
  {
    id: 'buttonCard3',
    type: 'card',
    position: { x: 290, y: 900 },
    data: { label: ['Trend', 'Control'], href: '/screens/trend-control' },
  },
  {
    id: 'buttonCard4',
    type: 'card',
    position: { x: 420, y: 900 },
    data: { label: ['Feed', 'System'], href: '/feed-system' },
  },
  {
    id: 'buttonCard5',
    type: 'card',
    position: { x: 550, y: 900 },
    data: { label: ['Product', 'Recovery'], href: '/screens/product-recovery' },
  },
  {
    id: 'buttonCard6',
    type: 'card',
    position: { x: 680, y: 900 },
    data: { label: ['M5', 'Startup', 'Overlay'], href: '/screens/m5-startup' },
  },
  {
    id: 'buttonCard7',
    type: 'card',
    position: { x: 810, y: 900 },
    data: { label: ['M5', 'Sequence', 'Overlay'], href: '/screens/m5-sequence' },
  },
  {
    id: 'buttonCard8',
    type: 'card',
    position: { x: 940, y: 900 },
    data: { label: ['- Level 3 -', 'M5', 'Interlocks'], href: '/screens/m5-interlocks' },
  },
  {
    id: 'buttonCard9',
    type: 'card',
    position: { x: 1070, y: 900 },
    data: { label: ['- Level 3 -', 'Cooling', 'System'], href: '/screens/cooling-system' },
  },
];
